...
public class Job implements Serializable{
	...
	public Job(int id, String name, int sex, int age, String job, String specialty, String experience,
			String studyeffort, String school, String tel, String email, Date createtime, String content, int isstock) {
		super();
		this.id = id;
		this.name = name;
		this.sex = sex;
